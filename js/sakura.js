...
sakura.setAttribute("style", "width:100%;height:100%;position:fixed;top:0;left:0;pointer-events: none;z-index:-1;");
// console.log(sakura)

// 设置sakura画布的宽高为浏览器视口宽高
...
class Sakura {
    ...
    constructor() {
        // 随机生成花瓣的x, y坐标
        this.x = Math.random() * sakura.width;
        this.y = (Math.random() * sakura.height * 2) - sakura.height;
        // 随机生成花瓣的宽高
    ...
    // 绘制
    draw() {
        // 当花瓣超过sakura画布边界后，重新设置花瓣的坐标、速度、和转速
        if (this.x > sakura.width || this.y > sakura.height) {
